            ...
            <form action="{{ route('admin.tambah-admin.store') }}" method="post">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-10">
                        ...
                        <div class="col-lg-8">
                            <input name="email" type="email" class="form-control" placeholder="Input email disini ...." required value="{{ old('email') }}">
                        </div>
                    </div>
                    ...
                    <div class="row mb-10">
                        ...
                        <div class="col-lg-8">
                            <input name="password" type="password" maxlength="8" class="form-control" placeholder="Input password disini ...." required>
                        </div>
                    </div>
                </div>
