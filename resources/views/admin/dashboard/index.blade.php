            ...
            <div class="browser-visits">
                <ul>
                    <li class="d-flex flex-wrap align-items-center">
                        <div class="icon"><img src="{{ asset('themes/deskapp2/vendors/images/chrome.png') }}" alt=""></div>
                        <div class="browser-name">Google Chrome</div>
                        <div class="visit"><span class="badge badge-pill badge-primary">50%</span></div>
                    </li>
                    <li class="d-flex flex-wrap align-items-center">
                        <div class="icon"><img src="{{ asset('themes/deskapp2/vendors/images/firefox.png') }}" alt=""></div>
                        <div class="browser-name">Mozilla Firefox</div>
                        <div class="visit"><span class="badge badge-pill badge-secondary">40%</span></div>
                    </li>
                    <li class="d-flex flex-wrap align-items-center">
                        <div class="icon"><img src="{{ asset('themes/deskapp2/vendors/images/safari.png') }}" alt=""></div>
                        <div class="browser-name">Safari</div>
                        <div class="visit"><span class="badge badge-pill badge-success">40%</span></div>
                    </li>
                    <li class="d-flex flex-wrap align-items-center">
                        <div class="icon"><img src="{{ asset('themes/deskapp2/vendors/images/edge.png') }}" alt=""></div>
                        <div class="browser-name">Microsoft Edge</div>
                        <div class="visit"><span class="badge badge-pill badge-warning">20%</span></div>
                    </li>
                    <li class="d-flex flex-wrap align-items-center">
                        <div class="icon"><img src="{{ asset('themes/deskapp2/vendors/images/opera.png') }}" alt=""></div>
...
@push('scripts')
<script src="{{ asset('themes/deskapp2/vendors/scripts/dashboard2.js') }}"></script>
<script src="{{ asset('themes/deskapp2/src/plugins/highcharts-6.0.7/code/highcharts.js') }}"></script>
<script src="{{ asset('themes/deskapp2/src/plugins/highcharts-6.0.7/code/highcharts-more.js') }}"></script>
@endpush